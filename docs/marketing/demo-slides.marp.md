...
| データソース | 中小企業庁 官公需情報ポータル（公開入札公示データ） |
...
- **OEMライセンス**: 自社ブランドで提供 — 月額固定 + API従量課金
...
| 形態 | 内容 | 目線 |
|------|------|------|
| **OEMライセンス** | 自社ブランドで提供。開発・運用はスグクル継続 | 月額固定 + 従量 |
| **技術連携** | 既存サービスに API 組込み。役割分担を明確化 | 個別相談 |
| **共同PoC** | 特定業種・特定地域で実証導入 | 短期検証 |
