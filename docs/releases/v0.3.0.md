...
v0.3.1 は、公開名を `jp-bids-mcp` に変更するリネームリリースです。
...
v0.3.1 is a rename release that changes the public package name to `jp-bids-mcp`.
...
v0.3.1 adalah rilis rename yang mengubah nama package publik menjadi `jp-bids-mcp`.
