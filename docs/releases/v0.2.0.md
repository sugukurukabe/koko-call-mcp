...
- Registry metadata検証と実API health checkをrelease gateへ追加。
...
- Added Registry metadata validation and live API health-check support to the release gate.
...
- Menambahkan validasi metadata Registry dan health check API live ke release gate.
