...
残りの改善点（Cloud Run互換化、Dockerfile、英語README、Completion実装、pytest追加）は[docs/contributions/jgrants-roadmap.md](../contributions/jgrants-roadmap.md)にロードマップを公開している。
...
- Jグランツ MCPの `accepting` カウントバグ修正PRをデジタル庁リポジトリに送信した
- 次の5本の貢献候補をロードマップとして公開している
