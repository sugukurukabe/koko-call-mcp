...
3. During beta (until 2026-07-01), authenticated connections expose the full Pro tool surface for review. After beta, a non-Pro key exposes only search_bids, rank_bids, list_recent_bids, get_bid_detail.
