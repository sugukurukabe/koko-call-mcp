...
- **Free tier vs Pro tier**: All 17 tools are free during the beta period (until end of September 2026). After that, Pro tools require an API key. Do not block users; the server returns clear errors when quota is exceeded.
